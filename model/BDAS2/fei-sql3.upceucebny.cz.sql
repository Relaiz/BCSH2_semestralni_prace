...
INSERT INTO prace_pozice (id_pozice, pozice_nazev, min_mzda, max_mzda) VALUES (prace_pozice_sequence.NEXTVAL, 'Programator',30000, 120000);
/
...
email_zamestnanec, odesilani_file_id_file, odesilani_file_id_klient, id_file1, id_klient1)
VALUES
(zamestnanec_sequence.NEXTVAL, 'Emma', 'Miller', 120000, '+1 (555) 234-5678', 6, 1, 1, 30, NULL, 3, 'emmamiller@gmail.com', NULL, NULL, NULL, NULL);
...
email_zamestnanec, odesilani_file_id_file, odesilani_file_id_klient, id_file1, id_klient1)
VALUES
(zamestnanec_sequence.NEXTVAL, 'Daniel', 'Cooper', 120000, '+1 (555) 345-6789', 22, 1, 1, 30, NULL, 3, 'danielcooper@gmail.com', NULL, NULL, NULL, NULL);
